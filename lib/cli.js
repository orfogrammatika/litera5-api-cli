            ...
            api
                ...
                switch (res.state) {
                    case litera5_api_js_client_1.CheckState.CHECKED_SUCCESS:
                        ...
                        (0, utils_1.saveTextFile)(`${resp.check}.html`, (_a = res.html) !== null && _a !== void 0 ? _a : '', args.result);
                        (0, utils_1.saveTextFile)(`${resp.check}.annotations.json`, JSON.stringify(res.annotations, null, 2), args.result);
                        (0, utils_1.saveTextFile)(`${resp.check}.stats.json`, JSON.stringify(res.stats, null, 2), args.result);
                        break;
